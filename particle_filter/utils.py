...
# ------------------------------------------------------------------------
def read_n_lidar_rays(wbt_file_path):
    with open(wbt_file_path, "r") as file:
        for line in file:
            if "horizontalResolution" in line:
                n_rays = int(line.strip().split()[1])
                return n_rays
        ...
        for line in file:
            ...
            if reading_wall:
                ...
                if "translation" in line:
                    ...
                    wall_poses.append(SE2(translation.x, translation.y, 0))
                    continue
                ...
                if "rotation" in line:
                    ...
                    wall_poses[-1] = (SE2(translation.x, translation.y, h))
                    # wall_poses.append(SE2(translation.x, translation.y, h))
                    # wall_poses.append(np.array([translation.x, translation.y, h]))
                    continue
