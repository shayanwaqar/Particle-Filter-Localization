...
class SE2:
    ...
    def __init__(self, x, y, h):
        ...
        array = [[self.c, -self.s, self.x],[self.s, self.c, self.y], [0, 0, 1]]
        self.T = np.array(array)
    ...
    def transform_point(self, point: Point) -> Point:
        ...
        new_y = None
        ######### START STUDENT CODE #########
        point_prime = np.dot(self.T, np.array([point.x, point.y, 1]))
        new_x = point_prime[0]
        new_y = point_prime[1]
    ...
    def compose(self, other: 'SE2') -> 'SE2':
        ...
        new_x, new_y = new_T[0,2], new_T[1,2]
        new_h = math.atan2(new_T[1,0], new_T[0, 0])
    ...
    def inverse(self) -> 'SE2':
        ...
        new_h = None
        ######### START STUDENT CODE #########
        t_inverse = np.linalg.inv(self.T)
        new_x, new_y = t_inverse[:2,2]
        new_h = -self.h
